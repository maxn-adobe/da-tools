 ...
 * attempt (an unreachable origin won't recover by retrying, and at scale retrying it is
 * catastrophically slow). Honors a `Retry-After` response header (seconds) when present, else
